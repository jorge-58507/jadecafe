...
<body>
    <div class="flex-center position-ref full-height">
        <div class="row">
            <div class="col-12 text-end">
                <button type="button" class="btn tmgreen_bg" data-bs-toggle="modal" data-bs-target="#accessControlModal"
                    onclick="cls_controlaccess.init()">
                ...
                <div class="text-center">
                    ...
                    <form method="POST" action="" id="form_logincode">
                        ...
                        <div class="form-group row">
                            <label for="logincode"
                                class="col-md-4 col-form-label text-md-right">{{ __('Acceso') }}</label>
                            <div class="col-md-6 mb-3">
                                <input id="logincode" type="password" class="form-control" name="logincode" value=""
                                    required autofocus>
                            </div>
                        </div>
                    ...
                    <div class="modal-body" id="accessControlModal_body">
                        <div class="row h_100">
                            <div class="col-6 text-center pb-3">
                                <button type="button" id="btn_set_in" class="btn btn-lg btn-success"
                                    onclick="cls_controlaccess.set_in(this)">Entrada</button>
                            </div>
                            <div class="col-6 text-center">
                                <button type="button" id="btn_set_out" class="btn btn-lg btn-primary"
                                    onclick="cls_controlaccess.set_out(this)">Salida</button>
                            </div>
                            <div class="col-6 text-center">
                                <button type="button" id="btn_set_breakin" class="btn btn-lg btn-info"
                                    onclick="cls_controlaccess.set_breakin(this)">Salida Almuerzo</button>
                            </div>
                            <div class="col-6 text-center">
                                <button type="button" id="btn_set_breakout" class="btn btn-lg btn-info"
                                    onclick="cls_controlaccess.set_breakout(this)">Entrada Almuerzo</button>
                            </div>
                            <div class="col-12" style="opacity: 0;">
                                <form action="" name="form_controlaccess_IN"
                                    onsubmit="event.preventDefault(); cls_controlaccess.in()">
                                    <input type="text" id="controlaccess_IN" name="controlaccess_IN"
                                        class="form-control" value="IN">
                                </form>
                                <form action="" name="form_controlaccess_OUT"
                                    onsubmit="event.preventDefault(); cls_controlaccess.out()">
                                    <input type="text" id="controlaccess_OUT" name="controlaccess_OUT"
                                        class="form-control" value="OUT">
                                </form>
                                <form action="" name="form_controlaccess_BREAKIN"
                                    onsubmit="event.preventDefault(); cls_controlaccess.breakin()">
                                    <input type="text" id="controlaccess_BREAKIN" name="controlaccess_BREAKIN"
                                        class="form-control" value="BREAKIN">
                                </form>
                                <form action="" name="form_controlaccess_BREAKOUT"
                                    onsubmit="event.preventDefault(); cls_controlaccess.breakout()">
                                    <input type="text" id="controlaccess_BREAKOUT" name="controlaccess_BREAKOUT"
                                        class="form-control" value="BREAKOUT">
                                </form>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('form_logincode').addEventListener("submit", (e) => {
            e.preventDefault();
            if (document.getElementById('logincode').value === '0000000000') {
                cls_general.shot_toast_bs('Ingrese un codigo valido', { bg: 'text-bg-warning' });
                return false;
            }
